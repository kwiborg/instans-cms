...
switch ($_REQUEST['do']) {
	...
	case 'ajax_dropboximport_init':
		include_once ($_SERVER['DOCUMENT_ROOT'].'/cms/modules/picturearchive/dropbox_import.php');
	...
	case 'new_show_images':
		$akkumulated_foldermenu = "";
		$_SESSION["CURRENT_OPEN_FOLDERS"][] = $_REQUEST[folder_id];
		//new_folder_view($_REQUEST[folder_id],);
		$file_view = new_file_view($_REQUEST[folder_id]);
		echo $akkumulated_foldermenu."¤¤¤¤¤||¤¤¤¤¤".$file_view;
	break;
