...
replaceSelector("h1","includes/gfxheadings.php",true);
var testURL = "includes/images/test.png" ;

var doNotPrintImages = true;
var printerCSS = "includes/css/replacement-print.css";

var hideFlicker = true;
var hideFlickerCSS = "includes/css/replacement-screen.css";
	...
	for(var i=0;i<items.length;i++)
	{
		...
		if(elements.length > 0) for(var j=0;j<elements.length;j++)
		{
			...
			for(var k=0;k<tokens.length;k++)
			{
				...
				image.alt = tokens[k] ;
				var cachebuster = Math.random()*10000;
				image.src = url+"&readcachebuster="+cachebuster;
