        ...
        <div id="sitewrapper">
            ...
            <div id="mainwrapper">
                <div id="leftmenu">
                    <?php
                        if (!$arr_content[mode]){
                            newBuildFrontendMenu(1, 1,  $arr_content["toplevel_id"], 0, $arr_content, "", "",$arr_content[arrPath], 10);
                            /*
                                ALTERNATIVT EN SUB-SUB-MENU MED:
                                newBuildFrontendMenu(1, 1, $arr_content["arrPath"][1], 0, $arr_content, "", "", $arr_content[arrPath])
                            */
                        } else {
                            /* 
                                MODE-SPECIFIKKE MENUER KAN LAVES HER
                            */ 
                            echo "<ul><li><a href='/'>Til websitets forside</a></li></ul>";
                        }
                    ?>
                    &nbsp;
                </div>
