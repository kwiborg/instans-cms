...
<html>
<head>
  <title><?php echo returnPageTitleTag($arr_content, "PUBLIKATOR: ") ?></title>
 ...
 echo $path = returnHTMLMenuPath(
  ...
  <div id="centerWrapper">
   <div id="menuWrapper">
    ...
    <?php 
	 if ($arr_content[lang]=="da") echo newBuildFrontendMenu(1,1,0,0, $arr_content, ""); 
	 if ($arr_content[lang]=="en") echo newBuildFrontendMenu(1,2,0,0, $arr_content, ""); 
	?>
